...
let 
    key = `d491cc83-b516-44d4-a262-bd9f6ec5aaee`,           // CHANGE THIS OR THE BOT WONT WORK!
    token = `ODg1ODMyMzc2ODc2NDA0NzQ3.YTsxsA.l19DOVkniQ_EiKAk1xOzyumYe58`,       // CHANGE THIS OR THE BOT WONT WORK!
    prefix = "h!"                       // Change this to yours!
;
// API Helpers
const embedHelper = { 
    footer: {
        text: 'Hypixel Monster by Luquistroll209',                                           // Change this to yours!
        image: {
...
client.on('ready', s => {
    ...
    client.user.setActivity(`Hypixel`, { type: 'LISTENING' })
